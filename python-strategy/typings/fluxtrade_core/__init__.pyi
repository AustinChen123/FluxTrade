...
class PyMatchingEngine:
    ...
    def __init__(
        ...
        settlement_model: str = "derivatives",
        base_asset: str = "",
        quote_asset: str = "",
        spot_fee_asset: str = "quote",
        market_slippage_bps: str = "0",
        market_slippage_price_tick: str | None = None,
    ) -> None: ...
    def submit_order(self, order: Order) -> str: ...
    def get_positions(self) -> dict[str, Position]: ...
    def get_position(self, strategy_id: str, product_id: str) -> Position | None: ...
    def drain_rejections(self) -> list[dict[str, str]]: ...
    def drain_warnings(self) -> list[dict[str, str]]: ...
    def get_asset_balance(self, asset: str, balance_type: str) -> str: ...
    def apply_external_funding(self, asset: str, amount: str) -> str: ...
    def cash_spot_account_snapshot(self, mark_price: str) -> dict[str, str]: ...
