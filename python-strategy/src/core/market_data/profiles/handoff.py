...
def parse_handoff(raw: bytes) -> ParsedHandoff:
    ...
    try:
        ...
        _require(payload["product_id"] == _PRODUCT and payload["algorithm_version"] == "vp-v1")
        ...
        _require(content.grid_id == "btc_spot_usdt_10_v1" and content.bin_origin == Decimal(0)
                 and content.bin_step == Decimal(10))
        ...
        recon = _keys(wire["reconciliation"], _RECON)
