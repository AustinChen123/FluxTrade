...
class BootstrapSeed(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("strategy_version COLLATE \"C\" ~ '^[A-Za-z0-9][A-Za-z0-9._+-]{0,127}$'", name="ck_mbs_strategy_version"),
...
class MarketDataDecisionOutcome(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("strategy_version COLLATE \"C\" ~ '^[A-Za-z0-9][A-Za-z0-9._+-]{0,127}$'", name="ck_mdo_version"),
...
class MarketDataDecisionInput(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("strategy_version COLLATE \"C\" ~ '^[A-Za-z0-9][A-Za-z0-9._+-]{0,127}$'", name="ck_mdd_version"),
